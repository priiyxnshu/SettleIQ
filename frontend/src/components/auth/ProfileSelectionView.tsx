...
export const ProfileSelectionView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 flex flex-col justify-between p-6 md:p-12 relative overflow-hidden font-sans antialiased selection:bg-blue-600 selection:text-white">
      {/* Background Subtle Gradient Blobs */}
      <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-blue-100/50 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-amber-100/50 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-4xl w-full mx-auto my-auto py-12 z-10 space-y-10">
        <div className="text-center space-y-3">
          <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full text-xs font-bold bg-blue-50 text-blue-700 border border-blue-200/80 mb-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
          ...
          <div 
            ...
            className="group relative bg-white hover:border-amber-400/80 border border-slate-200 rounded-3xl p-8 transition-all duration-200 cursor-pointer flex flex-col justify-between shadow-sm hover:shadow-xl hover:shadow-amber-500/5 hover:-translate-y-1"
          >
            <div className="space-y-5">
              <div className="flex items-start justify-between">
                <div className="flex items-center space-x-4">
                  <div className="h-14 w-14 rounded-2xl bg-amber-50 border border-amber-200 flex items-center justify-center text-lg font-black text-amber-700 shadow-inner group-hover:scale-105 transition">
                    {analyst.initials}
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-slate-500 font-medium">{analyst.roleTitle}</p>
                  </div>
                </div>
              ...
              <div className="pt-3 border-t border-slate-100 space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 rounded-lg text-xs font-semibold bg-slate-50 text-slate-700 border border-slate-200 flex items-center space-x-1.5">
          ...
          <div 
            ...
            className="group relative bg-white hover:border-blue-400/80 border border-slate-200 rounded-3xl p-8 transition-all duration-200 cursor-pointer flex flex-col justify-between shadow-sm hover:shadow-xl hover:shadow-blue-500/5 hover:-translate-y-1"
          >
            <div className="space-y-5">
              <div className="flex items-start justify-between">
                <div className="flex items-center space-x-4">
                  <div className="h-14 w-14 rounded-2xl bg-blue-50 border border-blue-200 flex items-center justify-center text-lg font-black text-blue-700 shadow-inner group-hover:scale-105 transition">
                    {manager.initials}
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-slate-500 font-medium">{manager.roleTitle}</p>
                  </div>
                </div>
      ...
      {/* Footer */}
      <div className="max-w-6xl w-full mx-auto text-center text-xs text-slate-400 font-medium z-10">
